...
export function WhatsappButton() {
  return (
    <Button
      ...
      size="lg"
      onClick={() => {
        const message = encodeURIComponent("Hello Green Thumb Team, I would like to know more about your initiatives and how I can contribute. 🌱");
        window.open(`https://wa.me/919371202875?text=${message}`, "_blank");
      }}
    >
